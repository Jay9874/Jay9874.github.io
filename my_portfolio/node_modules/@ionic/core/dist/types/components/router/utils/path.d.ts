...
export declare const writeSegments: (history: History, root: string, useHash: boolean, segments: string[], direction: RouterDirection, state: number, queryString?: string, fragment?: string) => void;
/**
